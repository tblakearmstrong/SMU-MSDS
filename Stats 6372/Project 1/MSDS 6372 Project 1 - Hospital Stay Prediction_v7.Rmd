...
label_map <- c(
  ...
  R.Cul.Rat = "Rtn. Culturing Ratio",
  R.CX.ray.Rat = "Rtn. Chest X-Ray Ratio",
  N.Beds = "Number of Beds",
  Avg.Pat = "Avg. No. of Patients",
  Avg.Nur = "Avg. Nurses Employed",
  Pct.Ser.Fac = "% of Avail Facilities",
...
label_map <- c(
  ...
  "log_Avg.Pat" = "Avg. No. of Patients",
  "log_Avg.Nur" = "Avg. Nurses Employed",
...
label_map <- c(
  "log_Age" = "Patient Age",
  "log_Inf.Risk" = "Infection Risk",
  "log_R.Cul.Rat" = "Rtn. Culturing Ratio",
  "log_R.CX.ray.Rat" = "Rtn. Chest X-Ray Ratio",
  "log_N.Beds" = "Number of Beds",
  "log_Avg.Pat" = "Avg. No. of Patients",
  "log_Avg.Nur" = "Avg. Nurses Employed",
  "log_Pct.Ser.Fac" = "% of Available Facilities",
...
### Now we add interactions between each of our Numeric variables and each of our categorical variables.
    ...
    test <- hospital[-train_idx, ]
    # Fit model
    mlr_interations_all <- lm(mlr_interactions_all_formula, data = train)
    summary(mlr_interations_all)
    mse_mlr_interactions_all <- mean((myPredictions - test$Lgth.of.Sty)^2)
    mse_mlr_interactions_all  # So, all that complexity, and as expected, we LOSE precision, MSE= 1.004156
